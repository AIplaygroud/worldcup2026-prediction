...
- `competition/`: 2026 World Cup advancement rules, match environment/law changes for prediction, group assignments, **full group-stage fixtures (72 matches)**, standings, R2 advancement strategy notes, round-of-32 template, and full Annex C lookup table (495 rows).
